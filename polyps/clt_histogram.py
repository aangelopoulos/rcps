...
def trial(img_names, sigmoids, masks, num_components, gamma, delta, num_calib, num_lam, lam_lim):
    _, _, calib_sigmoids, val_sigmoids, calib_masks, val_masks, calib_num_components, val_num_components = calib_test_split(img_names, sigmoids, masks, num_components, num_calib)
